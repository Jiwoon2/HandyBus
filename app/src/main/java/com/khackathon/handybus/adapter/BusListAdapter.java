...
import com.khackathon.handybus.databinding.BuslistItemBinding;
import com.khackathon.handybus.model.BusList_Item;
import com.khackathon.handybus.activity.BusInfo;
...
public class BusListAdapter extends RecyclerView.Adapter<BusListAdapter.ViewHolder>{
    ...
    public BusListAdapter(ArrayList<BusList_Item> items){this.items = items;}
...
//        return new ViewHolder(itemView);
        ...
        //데이터 바인딩
        BuslistItemBinding buslistItemBinding=  DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
...
//        TextView arrmsg2;
        ...
        private final BuslistItemBinding buslistBinding;

        public ViewHolder(@NotNull BuslistItemBinding buslistBinding) {
