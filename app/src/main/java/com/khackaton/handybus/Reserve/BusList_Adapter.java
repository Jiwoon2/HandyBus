...
public class BusList_Adapter extends RecyclerView.Adapter<BusList_Adapter.ViewHolder> {
    Intent intent;
    ArrayList<BusList_Item> items = new ArrayList<>();

    BusList_Adapter(ArrayList<BusList_Item>items){this.items = items;}
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.reserve_bus_list_recycle_fragment, parent, false);
        return new BusList_Adapter.ViewHolder(itemView);
    }
