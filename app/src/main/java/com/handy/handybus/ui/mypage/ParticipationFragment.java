...
import com.handy.handybus.databinding.FragmentParticipationBinding;
...
public class ParticipationFragment extends Fragment {
    ...
    private ParticipationViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(ParticipationViewModel.class);
