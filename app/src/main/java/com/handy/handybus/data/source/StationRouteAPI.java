...
public class StationRouteAPI {
    ...
    public ArrayList<StationRoute_Item> search_StationRoute(Context root, String busRouteId) throws UnsupportedEncodingException { //edit에 검색어가 들어갈 것
        ...
        StringRequest request = new StringRequest(Request.Method.GET, "http://ws.bus.go.kr/api/rest/busRouteInfo/getStaionByRoute?ServiceKey=" + key + "&busRouteId=" + location, new Response.Listener<String>() {
            @Override
...
//                                            break;
    ...
    public LiveData<List<StationRoute_Item>> searchStationRouteV2(Context root, String busRouteId) throws UnsupportedEncodingException { //edit에 검색어가 들어갈 것
        final MutableLiveData<List<StationRoute_Item>> liveData = new MutableLiveData<>();
        final ArrayList<StationRoute_Item> items = new ArrayList<>();
