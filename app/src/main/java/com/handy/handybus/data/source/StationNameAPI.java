...
public class StationNameAPI {
    ...
    public ArrayList<BusStop_Item> search_stationName(View root, String busRouteNm) throws UnsupportedEncodingException { //edit에 검색어가 들어갈 것
        ...
        StringRequest request = new StringRequest(Request.Method.GET, "http://ws.bus.go.kr/api/rest/stationinfo/getLowStationByName?" + "ServiceKey=" + key + "&stSrch=" + location, new Response.Listener<String>() {
            @Override
